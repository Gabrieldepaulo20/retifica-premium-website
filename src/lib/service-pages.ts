...
export const serviceDetailPages = [
  {
    ...
    hero: "Retífica de cabeçote: avaliação e orçamento antes de autorizar o serviço",
    intro:
    ...
    process: [
      ...
      "Informamos as operações, o orçamento e o prazo para aprovação antes da usinagem.",
